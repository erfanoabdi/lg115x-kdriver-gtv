...
#define ADEC_IOW_SET_MIX_CH_VOLUME					_IOW(ADEC_IOC_MAGIC, 57, LX_ADEC_MIX_CH_VOL_T)
...
typedef  enum
{
	...
	LX_ADEC_IN_PORT_TVP		= 10,	///< From TVP System Memory
} LX_ADEC_IN_PORT_T;
...
typedef  enum
{
	...
	LX_ADEC_LLB_BUF 		= 0x200, 	///< PCM Audio Mix in PCM LLB(Low Latency Buffer)
} LX_ADEC_DEC_MODE_T;
...
/**
 * ADEC Mix Channel Volume Info.
 * This enumeration describes the ADEC Mix Channel Volume information.
 * adec ioctl parameter.
 * @see ADEC_IOW_SET_MIX_CH_VOLUME
*/
typedef struct LX_ADEC_MIX_CH_VOL{
	LX_ADEC_DEC_MODE_T		adecMode;		///< The mode of ADEC decoder

	UINT32 					mixLeftVolume;	///< The value of mix audio left volume.
	UINT32 					mixRightVolume;	///< The value of mix audio right volume.
} LX_ADEC_MIX_CH_VOL_T;
