...
/** @file
 *
 *  application interface header for sdec device
 *
...
// Debug
#define SDEC_IOW_ENABLE_LOG					_IOWR(SDEC_IOC_MAGIC, 40, UINT32)
#define SDEC_IOW_SET_FCW						_IOWR(SDEC_IOC_MAGIC, 41, UINT32)
#define SDEC_IOR_GET_REG						_IOWR(SDEC_IOC_MAGIC, 42, LX_SDEC_GET_REG_T)
#define SDEC_IOR_SET_REG						_IOWR(SDEC_IOC_MAGIC, 43, LX_SDEC_SET_REG_T)

#define SDEC_IOW_GET_CIPHER_KEY				_IOWR(SDEC_IOC_MAGIC, 45, LX_SDEC_GET_CIPHERKEY_T)
#define SDEC_IOW_ENABLE_INPUT_PORT			_IOWR(SDEC_IOC_MAGIC, 50, LX_SDEC_ENABLE_INPUT_T)
...
typedef enum
{
	LX_SDEC_INPUT_SERIAL0		= 0,			/**< Serial from External DEMOD or CI */
	LX_SDEC_INPUT_SERIAL1		= 1,			/**< Serial from External DEMOD or CI */
	LX_SDEC_INPUT_PARALLEL0 		= 2,			/**< Parallel from internal DEMOD or CI */
	LX_SDEC_INPUT_PARALLEL1 		= 3,			/**< Parallel from internal DEMOD or CI */
	LX_SDEC_INPUT_DVR					= 4,			/**< Input From DVR UP Channel */
} LX_SDEC_INPUT_T;
...
typedef enum
{
	LX_SDEC_FROM_SDEC	 				= 0x0,
	LX_SDEC_FROM_SENC					= 0x1,
	LX_SDEC_FROM_CDIC					= 0x2,
} LX_SDEC_DN_SRC_T;


typedef enum{
	LX_SDEC_CDIOP_SERIAL_0		= 0x0,
	LX_SDEC_CDIOP_SERIAL_1		= 0x1
 }LX_SDEC_CDIOP_PCONF_T;

typedef enum{
	LX_SDEC_CDIP_SERIAL_0		= 0x0,
	LX_SDEC_CDIP_SERIAL_1		= 0x1,
	LX_SDEC_CDIP_PARALLEL_0		= 0x2,
	LX_SDEC_CDIP_PARALLEL_1		= 0x3
 }LX_SDEC_CDIP_PCONF_T;

typedef enum{
	LX_SDEC_CDIP_47DETECTION		= 0x0,
	LX_SDEC_CDIP_NEG_SOP			= 0x1,
	LX_SDEC_CDIP_POS_SOP			= 0x2,
	LX_SDEC_CDIP_BOTH_SOP		= 0x3
