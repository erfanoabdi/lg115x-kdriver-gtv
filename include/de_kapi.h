...
#define DE_IOW_OIF_SET_LVDS_POLARITY	_IOW(DE_IOC_MAGIC, 57, LX_DE_OIF_LVDS_POLARITY_T)			// add 2012. 05. 07 for GCD(URSA3)
...
typedef enum {
	...
	LX_PANEL_DEV_BOX,		///< Set-top box device
...
/**
 * OIF LVDS polaritycontrol parameter.
 */
...
typedef enum {
	...
	LX_DE_MULTI_IN_CVD_CVD,		// exception case for e.g. DTV ---> ATV ---> DTV Delay ---> ATV
	LX_DE_MULTI_IN_ADC_CVD,		// L9B0 only
	LX_DE_MULTI_IN_ADC_HDMI = 5,
	LX_DE_MULTI_IN_ADC_MVI,
	LX_DE_MULTI_IN_ADC_ADC,
	LX_DE_MULTI_IN_HDMI_CVD,		// L9B0 only
	LX_DE_MULTI_IN_HDMI_ADC,
	LX_DE_MULTI_IN_HDMI_MVI = 10,
	LX_DE_MULTI_IN_HDMI_HDMI,
	LX_DE_MULTI_IN_MVI_CVD,		// L9B0 only
	LX_DE_MULTI_IN_MVI_ADC,
	LX_DE_MULTI_IN_MVI_HDMI,
	LX_DE_MULTI_IN_MVI_MVI = 15,
