...
@def AAD_IOW_SIF_SET_BTSC_A2_LEVEL
Sets a threshold level of BTSC or A2 sound system.
...
@def AAD_IOR_SIF_GET_BTSC_A2_LEVEL
Gets a threshold level of BTSC or A2 sound system.
The current threshold level is returned using UINT16 value.
...
#define AAD_IOW_SIF_SET_HIGH_DEV_MODE				_IOW(AAD_IOC_MAGIC,  1, LX_AAD_HIGH_DEV_LEVEL_T)
...
#define AAD_IOW_SIF_SET_BTSC_A2_LEVEL				_IOW(AAD_IOC_MAGIC,  5, LX_AAD_SIF_THRESHOLD_T)
...
#define AAD_IOR_SIF_GET_BTSC_A2_LEVEL				_IOWR(AAD_IOC_MAGIC, 8, LX_AAD_SIF_THRESHOLD_T)
...
typedef  enum
{
	...
	LX_AAD_INIT_ATSC_BTSC_SELECT	= 2,		///< INIT TYPE : TV Systems for BTSC enabled in ATSC system
	LX_AAD_INIT_ATSC_EIAJ_SELECT	= 3,		///< INIT TYPE : TV Systems for EIA-J JAPAN in ATSC system
	LX_AAD_INIT_DVB_SELECT 			= 4,		///< INIT TYPE : TV Systems for EU in DVB system
	LX_AAD_INIT_DVB_TW_SELECT		= 5,		///< INIT TYPE : TV Systems for TW(Taiwan, BTSC) in DVB system
	LX_AAD_INIT_DVB_ID_SELECT		= 6,		///< INIT TYPE : TV Systems for ID(Indonesia) in DVB(PAL B/G) system
	LX_AAD_INIT_DVB_IN_SELECT		= 7,		///< INIT TYPE : TV Systems for IN(India) in DVB(PAL B) system
	LX_AAD_INIT_DVB_CN_SELECT		= 8,		///< INIT TYPE : TV Systems for CN(China) in DVB system
	LX_AAD_INIT_DVB_AU_SELECT		= 9,		///< INIT TYPE : TV Systems for AU(Australia) in DVB system
	LX_AAD_INIT_ATSC_BR_SELECT		= 10,		///< INIT TYPE : TV Systems for BR(Brazil, BTSC) enabled in ATSC system
 ...
 * aad ioctl parameter.
 * @see AAD_IOW_SIF_SET_BTSC_A2_LEVEL
*/
...
typedef  enum
{
	...
	LX_AAD_REG_TASK_START	= 6,	///< AAD Monitor Task Start for KOREA A2 Signal
	LX_AAD_REG_TASK_STOP	= 7		///< AAD Monitor Task Stop for KOREA A2 Signal
} LX_AAD_REG_MODE_T;
