...
#define	AFE_IOW_LVDS_SRC_CONTROL_T				_IOW(AFE_IOC_MAGIC, 66, UINT32)
...
#define MV_VBI_DETECTED			0x00000010		///< Macrovisioin VBI pseudo-sync pulses detection
#define MV_COLOURSTRIPSE		0x00000020			///< Macrovision color stripes detected.
...
typedef struct
{
	...
	UINT32 hnon_standard;			/// < hnon_standard flag
	UINT32 vnon_standard;			/// < vnon_standard flag
	UINT32	burst_mag;				/// < burst_magnitude
	UINT32 vdetect_vcount;			/// < vdetect vcount value
	UINT32	agc_peak_en;			/// < agc peak en
	UINT32	agc_bypass;				/// < agc_bypass 
