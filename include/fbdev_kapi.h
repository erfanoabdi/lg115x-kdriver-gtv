...
#define FBDEV_IOR_GET_FRC_PHY_MEMORY	_IOR(FBDEV_IOC_MAGIC, FBDEV_IOC_IDX(41), LX_FBDEV_PHY_MEMORY_T )
...
#define	FBDEV_IOW_SET_PARTIAL_UPDATE	_IOW(FBDEV_IOC_MAGIC, FBDEV_IOC_IDX(45), LX_FBDEV_PARTIAL_UPDATE_T )

#if (KDRV_PLATFORM == KDRV_COSMO_PLATFORM)
#define FBDEV_IOW_SET_VSYNC_EVENT			_IOW(FBDEV_IOC_MAGIC, FBDEV_IOC_IDX(46), UINT32 )
#endif
...
typedef struct
{
	...
	UINT32			fb_mem_base;			/**< FBDEV memory base address. set during system boot */
	UINT32			fb_mem_size;			/**< FBDEV memory size. set during system boot */
}
LX_FBDEV_CFG_T;
...
typedef struct
{
#define	LX_FBDEV_TRID_MODE_NONE		0	/** 3D mode off */
#define	LX_FBDEV_TRID_MODE_2D		1	/** 3D mode none */
#define	LX_FBDEV_TRID_MODE_TB		2	/** 3D mode T/B */
#define	LX_FBDEV_TRID_MODE_SS		3	/** 3D mode S/S */
	UINT8				mode;
	SINT16				disparity;
}
