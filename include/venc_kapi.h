...
// For TS Mux
#define LX_VENC_IOR_ENC_GET_STC			_IOR(VENC_IOC_MAGIC, 14, LX_VENC_ENC_STC_T )
#define LX_VENC_IOR_PREP_GET_STC		_IOR(VENC_IOC_MAGIC, 15, UINT32 )
#define LX_VENC_IOR_GET_PREP_DE_STATUS	_IOR(VENC_IOC_MAGIC, 16, LX_VENC_DE_STATUS_T )

#define VENC_IOC_MAXNR					17
/** @} */
...
typedef enum
{
	...
	LX_VENC_INPUT_MAX		= LX_VENC_INPUT_MJPEG
} LX_VENC_INPUT_T;
