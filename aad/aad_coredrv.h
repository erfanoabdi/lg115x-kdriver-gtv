...
//define  Mono/stereo check value for BTSC US signal
#define FM_SUBCARRIER_NOISE_THD_HI_US	0x38		// 0x14
#define FM_SUBCARRIER_NOISE_THD_LO_US	0x20		// 0x0A
#define PILOT_MAG_AAOS_THD_HI_US		0x50		// 0xB0
#define PILOT_MAG_AAOS_THD_LO_US		0x48		// 0x64

//define  Mono/stereo check value for BTSC Brazil signal
#define FM_SUBCARRIER_NOISE_THD_HI_BR	0x38		// 0x14
#define FM_SUBCARRIER_NOISE_THD_LO_BR	0x20		// 0x0A
#define PILOT_MAG_AAOS_THD_HI_BR		0x50		// 0xB0
#define PILOT_MAG_AAOS_THD_LO_BR		0x48		// 0x64

//define  Mono/stereo check value for BTSC Taiwan signal
#define FM_SUBCARRIER_NOISE_THD_HI_TW	0x38		// 0x14
#define FM_SUBCARRIER_NOISE_THD_LO_TW	0x20		// 0x0A
#define PILOT_MAG_AAOS_THD_HI_TW		0x50		// 0xB0
#define PILOT_MAG_AAOS_THD_LO_TW		0x48		// 0x64
...
#define AAD_MONOTOR_TASK_PRINT_TIME		((200/AAD_MONOTOR_TASK_TIMEOUT)+1)	// 0.2xx seconds
...
#if 0
	LX_ADEC_TASK_RESET_DSP0		= 1,	///< Reset DSP0 with exception handler interrupt
	LX_ADEC_TASK_RESET_DSP1		= 2,	///< Reset DSP1 with exception handler interrupt
	LX_ADEC_TASK_SET_SPDIF		= 3,	///< Set SPDIF clock
	LX_ADEC_TASK_USE_GSTC		= 4,	///< Use GSTC for MHEG TP stream lipsync
	LX_ADEC_TASK_SET_DTO_RATE	= 5,	///< Set SPDIF DTO Clock Rate
#endif
} LX_AAD_TASK_MSG_T;
