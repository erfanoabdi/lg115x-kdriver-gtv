...
#ifndef _PNG_REG_L8_H_
#define _PNG_REG_L8_H_
...
#endif	/* _PNG_REG_L8_H_ */

/* from 'LG1150-VID-MAN-02 v1.0 (PNG Register Description-20091229).csv' 20100311 00:54:20   대한민국 표준시 by getregs v2.3 */
