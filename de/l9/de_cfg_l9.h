...
#define VIDEO_L9_FIRMWARE_ROW_BASE_DDR_UP	(VIDEO_L9_FIRMWARE_ROW_BASE_OF_IPC + VIDEO_L9_FIRMWARE_ROW_SIZE_IPC_MC)
#define VIDEO_L9_FIRMWARE_ROW_BASE_OF_TTX	(VIDEO_L9_FIRMWARE_ROW_BASE_DDR_UP + VIDEO_L9_FIRMWARE_ROW_SIZE_DDR_UP)
#define VIDEO_L9_FIRMWARE_ROW_BASE_REG_TR	(VIDEO_L9_FIRMWARE_ROW_BASE_OF_TTX + VIDEO_L9_FIRMWARE_ROW_SIZE_OF_TTX)
