...
typedef enum {
	...
	DE_IPC_GET_PAR_INFO					/* 0x00000050 */, ///< get information of pixel aspect ratio
	DE_IPC_SET_PLATFORM_VERSION			/* 0x00000051 */, ///< get information of pixel aspect ratio
	DE_IPC_SET_MULTI_VISION				/* 0x00000052 */, ///< set information of multi vision
