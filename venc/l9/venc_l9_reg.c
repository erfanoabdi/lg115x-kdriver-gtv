...
//	volatile UINT32 *pui32SeqInfo = (UINT32*)((UINT32)_gpVencBase + 0x00B4); // 0xC000A0B4
...
{
	//return *((volatile UINT32 *)((UINT32)_gpVencBase + 0x0D4));
	return VENC_REG_RD32( VENC_PREP_STC_VALUE );
}

static UINT32
_VENC_REG_PREP_GetDEDSize( UINT16 *o_pui16Width, UINT16 *o_pui16Height )
{
...
{
#if 0	/* Temporary De setting */
	static UINT32 ui32Register[2];
	switch ( i_ui8Command & 0x0F )
	{
		case 3:
		{
			*((volatile UINT32 *)(0xC00208F4)) = ui32Register[0];
			*((volatile UINT32 *)(0xC00228BC)) = ui32Register[1];
		}
		break;
		...
		case 4:
		{
			ui32Register[0] = *((volatile UINT32 *)(0xC00208F4));
			ui32Register[1] = *((volatile UINT32 *)(0xC00228BC));
			*((volatile UINT32 *)(0xC00208F4)) = 0x00000022;
			*((volatile UINT32 *)(0xC00228BC)) = 0x00000022;
		}
		break;
...
static void
_VENC_REG_IPC_GetGauge( UINT16 *o_pui16SliceCount, UINT16 *o_pui16EncodingDuration )
{
	if ( o_pui16SliceCount == NULL || o_pui16EncodingDuration == NULL )
	{
		return;
	}

	*o_pui16SliceCount = _gpIpcReg->venc_gauge.le.slice_counter;
...
VENC_REG_API_T gpRegApiL9 =
{
	...
	.PREP_GetDEDSize				= _VENC_REG_PREP_GetDEDSize,
	...
	.IPC_GetGauge					= _VENC_REG_IPC_GetGauge,
};
