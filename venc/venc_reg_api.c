...
extern VENC_REG_API_T gpRegApiL8;
...
UINT32	VENC_REG_PREP_GetDEDSize ( UINT16 *o_pui16Width, UINT16 *o_pui16Height )
{
	return VENC_RUN( PREP_GetDEDSize, (o_pui16Width, o_pui16Height) );
}
...
void	VENC_REG_IPC_GetGauge( UINT16 *o_pui32SliceCount, UINT16 *o_pui16EncodingDuration )
{
	VENC_RUN( IPC_GetGauge, (o_pui32SliceCount, o_pui16EncodingDuration) );
}
