...
int TTX_HWUninitialize_L8Bx(void)
{
	int ret = 0;
...
int TTX_SetInputFormat_L8Bx(eVBIDataType type)
{
	...
	switch(type)
	{
		...
		case eTTX625B:
			...
			memcpy((void *)&gVportRegBx->vbi_015 , (void *)&value , sizeof(int) );
			gVportRegBx->vbi_016.reg_wss625_frame_start = 0x2;
			gVportRegBx->vbi_016.reg_teletext_frame_start = 0x3;
			gVportRegBx->iris_041.reg_vsync_vbi_max = 0x25;
			gVportRegBx->vbi_004.reg_vbi_muxout = 0;
			gVportRegBx->vbi_004.reg_vbi_hsyncout = 0;
			gVportRegBx->vbi_004.reg_vbi_en = VBI_ON;
...
int TTX_ParsingVBIData_L8Bx(sHeaderData *data )
{
	...
	{
		case 0:
			data->start = gVportRegBx->vbi_ctrl_002.reg_vbi0_start_addr;
			data->end = gVportRegBx->vbi_ctrl_003.reg_vbi0_end_addr;
			data->count = gVportRegBx->vbi_ctrl_002.reg_vbi0_data_cnt;
		break;
		case 1:
			data->start = gVportRegBx->vbi_ctrl_004.reg_vbi1_start_addr;
			data->end = gVportRegBx->vbi_ctrl_005.reg_vbi1_end_addr;
			data->count = gVportRegBx->vbi_ctrl_004.reg_vbi1_data_cnt;
		break;
		case 2:
			data->start = gVportRegBx->vbi_ctrl_006.reg_vbi2_start_addr;
			data->end = gVportRegBx->vbi_ctrl_007.reg_vbi2_end_addr;
			data->count = gVportRegBx->vbi_ctrl_006.reg_vbi2_data_cnt;
		break;
		case 3:
			data->start = gVportRegBx->vbi_ctrl_008.reg_vbi3_start_addr;
			data->end = gVportRegBx->vbi_ctrl_009.reg_vbi3_end_addr;
			data->count = gVportRegBx->vbi_ctrl_008.reg_vbi3_data_cnt;
		break;
	}
