...
/** @file
 *
 *  Linux proc interface for ttx device.
...
/*----------------------------------------------------------------------------------------
	Static Variables
----------------------------------------------------------------------------------------*/
static OS_PROC_DESC_TABLE_T	_g_ttx_device_proc_table[] =
{
...
/*
 * read_proc implementation of ttx device
 *
*/
static int	_TTX_ReadProcFunction(	UINT32 procId, char* buffer )
{
	int		ret = 0;
 ...
 *
*/
static int _TTX_WriteProcFunction( UINT32 procId, char* command )
{
	/* TODO: add your proc_write implementation */
	switch( procId )
	{
...
/**
 * initialize proc utility for ttx device
 *
 * @see TTX_Init
*/
void	TTX_PROC_Init (void)
{
	OS_PROC_CreateEntryEx ( TTX_MODULE, _g_ttx_device_proc_table,
											_TTX_ReadProcFunction,
											_TTX_WriteProcFunction );
}

/**
 * cleanup proc utility for ttx device
 *
 * @see TTX_Cleanup
*/
void	TTX_PROC_Cleanup (void)
{
	OS_PROC_RemoveEntry( TTX_MODULE );
}
