...
PE_SUSPEND_STORE_T pe_suspend_store[] = {
	...
	{FALSE	,PE_SUSPEND_NRD_DNR	,sizeof(LX_PE_NRD_DNR_T)		,PE_ITEM_PKTFUNC(LX_PE_NRD_DNR_T), PE_NRD_SetFunction ,NULL},		
	{FALSE	,PE_SUSPEND_NRD_TNR ,sizeof(LX_PE_NRD_TNR_T)		,PE_ITEM_PKTFUNC(LX_PE_NRD_TNR_T), PE_NRD_SetFunction ,NULL},		
	...
	{FALSE	,PE_SUSPEND_SHP_RES ,sizeof(LX_PE_SHP_RES_T) ,PE_ITEM_PKTFUNC(LX_PE_SHP_RES_T), PE_SHP_SetFunction ,NULL},		
	{FALSE	,PE_SUSPEND_SHP_EDGE ,sizeof(LX_PE_SHP_EDGE_T) ,PE_ITEM_PKTFUNC(LX_PE_SHP_EDGE_T), PE_SHP_SetFunction ,NULL},		
	...
	{FALSE	,PE_SUSPEND_WIN_CTRL ,sizeof(LX_PE_WIN_CTRL_T) ,PE_ITEM_PKTFUNC(LX_PE_WIN_CTRL_T), PE_WIN_SetFunction ,NULL},			
	...
	{FALSE	,PE_SUSPEND_D3D_SETDEFAULT ,sizeof(LX_PE_DEFAULT_SETTINGS_T) ,PE_ITEM_PKTFUNC(LX_PE_DEFAULT_SETTINGS_T), PE_D3D_SetFunction ,NULL}, 		
};
