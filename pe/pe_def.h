...
#define PE_CHECK_MAIN(_win_id)		(((_win_id)==LX_PE_WIN_MAIN)||((_win_id)==LX_PE_WIN_ALL))
#define PE_CHECK_SUB(_win_id)		(((_win_id)==LX_PE_WIN_SUB)||((_win_id)==LX_PE_WIN_ALL))
#define PE_GET_CHECKED_WINID(_win_id)	(((_win_id)==LX_PE_WIN_ALL)? LX_PE_WIN_MAIN:(_win_id))
