 ...
 *   global Functions
 *---------------------------------------------------------------------------------------*/
 void Vdec_Freerun( UINT8 ui8Option) {};
...
//	stpSdecParam->ui32MsgMask = 0x01100011;
    ...
    if (lx_chip_plt() == LX_CHIP_PLATFORM_COSMO) {
		...
		/* DDRC Value change */
		virtaddr = (UINT32*)ioremap(0xc00013cc, sizeof(UINT32));
		REG_WRITE32(virtaddr, 0xf3cf0003);

		/* Memory Gating Disable */
		virtaddr = (UINT32*)ioremap(0xc000b020, sizeof(UINT32));
		REG_WRITE32(virtaddr, 0x0000000f);
	} else {
	/* DDRC Value change */
...
//TempTemp
//	stKmemAddr = stpSdecParam->stSDEC_MPG_Reg[stpLXSdecCipherKey->eCh]->kmem_addr;
	...
	{
//		stKmemAddr.word_idx = ui8count;
//		stpSdecParam->stSDEC_MPG_Reg[stpLXSdecCipherKey->eCh]->kmem_addr = stKmemAddr;
//		stpSdecParam->stSDEC_MPG_Reg[stpLXSdecCipherKey->eCh]->kmem_data.kmem_data = swab32(*ui32pAddr);
		SDEC_HAL_KMEMSet( stpLXSdecCipherKey->eCh, key_type, pid_idx, odd_key, ui8count, *ui32pAddr);
		ui32pAddr++;
	}

	SDEC_DTV_SOC_Message( SDEC_NORMAL, "SDEC_IO_SetCipherKey : idx[%d] eKeyMode[%d]", stpLXSdecCipherKey->uiPidFltId, stpLXSdecCipherKey->eKeyMode);
	SDEC_DTV_SOC_Message( SDEC_TRACE, "-->SDEC_IO_SetCipherKey");
...
//TempTemp
//		stpSdecParam->stSDEC_MPG_Reg[stpLXSdecCipherKey->eCh]->kmem_addr = stKmemAddr;
//		*ui32pAddr = swab32(stpSdecParam->stSDEC_MPG_Reg[stpLXSdecCipherKey->eCh]->kmem_data.kmem_data);
	...
	UINT32 ui32Arg)
{
	...
	if(bMain)	SDEC_HAL_STCCSetMain(ui8Ch);
	...
	UINT32 ui32Arg)
{
	...
	{
		case 0:
			stpSdecParam->stSDEC_TOP_Reg->dl_sel.dl0_sel = stLXSdecDlSel.eSrc;
			break;
		case 1:
			stpSdecParam->stSDEC_TOP_Reg->dl_sel.dl1_sel = stLXSdecDlSel.eSrc;
			break;
		default:
			break;
	}
	...
	UINT32 ui32Arg)
{
	...
	{
		stpLXSdecSecfltState->uiPattern[ui8wordIdx] = SDEC_HAL_SECFGetSecfData(ui8Ch, ui32SecFltId, ui8wordIdx);
	}
...
void action_pcr(S_SDEC_PARAM_T	*stpSdecParam, UINT8 cur_ch, UINT32 cur_pcr, UINT32 cur_stc)
{
	...
	{
		//SDEC_DTV_SOC_Message( SDEC_PCR, "MAX IGNORE Value");
	}
