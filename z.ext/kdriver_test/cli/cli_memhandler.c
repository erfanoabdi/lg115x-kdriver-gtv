...
extern int MemoryWriteWidth(unsigned int i_uiPhysicalAdd, unsigned int i_uiWidth, unsigned int i_uiValue);
extern int MemoryWrite(unsigned int i_uiPhysicalAdd, unsigned int i_uiValue);
extern int MemoryRead(unsigned int i_uiPhyAdd);
extern int PhysMemoryRead(unsigned int i_uiPhyAddr, unsigned int i_uiLength , unsigned int *i_pdata);
