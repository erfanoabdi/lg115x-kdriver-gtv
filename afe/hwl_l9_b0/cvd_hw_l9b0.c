...
UINT32 g_initial_c_coeff = 0x1050;
#else
UINT32 g_initial_c_coeff = 0;
#endif
/*----------------------------------------------------------------------------------------
...
void CVD_L9Bx_SW_Reset(LX_AFE_CVD_SELECT_T select_main_sub)
{
	...
	else
	{
		...
		// SET SW reset registers to '1'
		VPORT_L9B0_RdFL(chbcvd_003);
		VPORT_L9B0_Wr01(chbcvd_003, chbreg_lbadrgen_rst, 1);
		VPORT_L9B0_WrFL(chbcvd_003);
		VPORT_L9B0_RdFL(top_007);
		VPORT_L9B0_Wr01(top_007, reg_swrst_chbcvd, 1);
		VPORT_L9B0_WrFL(top_007);
		//Clear SW Reset Registers to '0'
		VPORT_L9B0_RdFL(chbcvd_003);
		VPORT_L9B0_Wr01(chbcvd_003, chbreg_lbadrgen_rst, 0);
		VPORT_L9B0_WrFL(chbcvd_003);
		VPORT_L9B0_RdFL(top_007);
		VPORT_L9B0_Wr01(top_007, reg_swrst_chbcvd, 0);
		VPORT_L9B0_WrFL(top_007);
#endif
	}
}
...
void CVD_L9Bx_Reg_Init(LX_AFE_CVD_SELECT_T select_main_sub)
{
	...
	*/
	...
	{
#if 0 //FIXME : chbcvd is moved to VDEC
		VPORT_L9B0_RdFL(chbcvd_007);
		VPORT_L9B0_Wr01(chbcvd_007, chbreg_blue_mode, 0x0);
		VPORT_L9B0_WrFL(chbcvd_007);
#endif
