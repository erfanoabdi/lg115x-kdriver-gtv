...
#if 0
typedef struct {
	/* // Main CVD Power Down Control
	UINT8	reg_cvbspll_pdb;
	UINT8	CVBS_PDBM;
	UINT8	CVBS1_PDB;
	UINT8	CVBS2_PDB;
*/
	...
	/* //CVD SW RESET
	UINT8 reg_swrst_exta;
	UINT8 reg_swrst_extb;
	UINT8 reg_swrst_f81;
	UINT8 reg_swrst_irisin;
	UINT8 reg_swrst_irisyc;
	UINT8 reg_swrst_irisrm;
	UINT8 reg_swrst_iriswm;
	*/

	/* Add 2010/06/01 Kim.min*/
	UINT8 reg_lose_chromalock_mode;
...
} 	CVD_L9Ax_SET_CROSS_COLOR_REDUCER_T;
...
//	UINT8	reg_adaptive_chroma_mode;
	...
	UINT8	reg_3dcomb_mdi_sadsel;			//New at L9

}	CVD_L9Ax_SET_MOTION_DETECTOR_T;
...
}	CVD_L9Ax_SET_GLOBAL_CLASSIFIER_T;
...
typedef struct {
	...
	UINT32	reg_3dcomb_coefi__2;
	UINT32	reg_3dcomb_coefi__3;
}	CVD_L9Ax_SET_BLENDING_T;

//added 110623
typedef struct {
	UINT8	reg_adaptive_chroma_mode;
	UINT8	reg_chroma_bw_lo;
}	CVD_L9Ax_SET_CHROMA_DEMODE_T;
...
}	CVD_L9Ax_SET_OUPUT_RANGE_T;

typedef struct {
	UINT8	reg_peak_en;
	UINT8	reg_peak_gain;
	UINT8	reg_peak_range;
	UINT8	reg_secam_ybw;
}	CVD_L9Ax_SET_LUMA_PEAKING_T;

typedef struct {
	UINT16	reg_dr_freq;
	UINT16	reg_db_freq;
}	CVD_L9Ax_SET_SECAM_FREQ_T;
...
typedef struct {
	...
	UINT8	cvd_color_system;
	UINT8	cs0_color_system;
	UINT8	cs1_color_system;

	UINT8	in_color_system_detecting;	///< cvd in color system detection process
	UINT8	color_system_detected;		///< color system detected
	UINT8	cvd_next_state;
	UINT8	cs0_next_state;
	UINT8	cs1_next_state;
...
//void CVD_L9Ax_Program_Color_System_Main(CVD_SET_SYSTEM_MAIN_T set_system_t);
//void CVD_L9Ax_Program_Color_System_CHB(CVD_SET_SYSTEM_CHB_T set_system_t);
