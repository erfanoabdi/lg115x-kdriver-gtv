...
typedef struct {
	INTR_VP1_ENABLE_Ax                 	intr_vp1_enable                 ;	// 0xc0007000 : ''
	chb_cvd_pal_detected            	chb_cvd_pal_detected            ;	// 0xc0007001 : ''
	INTR_VP1_CLEAR_Ax                  	intr_vp1_clear                  ;	// 0xc0007002 : ''
	INTR_VP2_ENABLE_Ax                 	intr_vp2_enable                 ;	// 0xc0007003 : ''
	VPORT_INTR_STATUS                       vport_intr_status               ;	// 0xc0007004 : ''
	INTR_VP2_CLEAR_Ax                  	intr_vp2_clear                  ;	// 0xc0007005 : ''
	INTR_VP3_ENABLE_Ax                 	intr_vp3_enable                 ;	// 0xc0007006 : ''
	HDMI_STATUS                        	hdmi_status                     ;	// 0xc0007007 : ''
	INTR_VP3_CLEAR_Ax                  	intr_vp3_clear                  ;	// 0xc0007008 : ''
